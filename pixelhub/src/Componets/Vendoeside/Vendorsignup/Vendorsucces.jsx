...
function Vendorsucces() {
  ...
  return (
    ...
    <div className=" animate-pulse w-96 h-60 rounded-2xl bg-blue-500 flex-row items-center h-full justify-center space-x-5">
        ...
        <p className='pt-6 pl-3 mb-4 text-white'> Your registration has been completed. Our admin will verify it and respond to you soon.</p>
        <div className='pl-28'>
  <Link to="/"> 
