...
function Coursedetailview() {
  ...
  const handleEditClick = () => {
    // Navigate to the edit form page and pass the courseId as a parameter
    navigate(`/vendor/edit_course/${courseId}`);
  };
  return (
    <div>
      <Vendornav/>
        <div className='p-4 bg-[#1F2A40]'>
            <div class="flex mb-4">
                ...
                <div class="w-1/2 bg-[#1F2A40]h-14 flex items-center">
                    <button class="relative inline-flex items-center justify-center px-6 py-2 overflow-hidden font-mono font-medium tracking-tighter text-white bg-gray-800 rounded-lg group ml-auto "  onClick={handleEditClick}>
