...
import logo from '../../../static/achivee.png';
...
function Achivemets() {
  return (
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1380px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0'>
            
            <div className='flex flex-col justify-center '>
                <h1 className='md:leading-[72px] text-3xl font-bold'>Our <span className='text-[#2d737a]'>Achievements</span></h1>
             ...
             <img  src={logo} className="m-auto md:order-last  order-first" />
